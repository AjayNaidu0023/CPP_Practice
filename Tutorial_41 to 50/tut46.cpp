...
>>In multiple inheritances, base classes are constructed in the order in which they appear
...
******** Special of Virtual base class ********
>>The constructors for virtual base classes are invoked before a non-virtual base class
>>If there are multiple virtual base classes, they are invoked in the order declared
>>Any non-virtual base class are then constructed before the derived class constructor is 
    executed
